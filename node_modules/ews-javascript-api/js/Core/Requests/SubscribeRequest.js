...
var SubscribeRequest = (function (_super) {
    ...
    SubscribeRequest.prototype.Validate = function () {
        ...
        if (ExtensionMethods_1.ArrayHelper.OfType(this.EventTypes, function (eventType) { return eventType === EventType_1.EventType.Status; }).length > 0) {
        ...
        this.EventTypes.forEach(function (eventType) {
            EwsUtilities_1.EwsUtilities.ValidateEnumVersionValue(EnumToExchangeVersionMappingHelper_1.EnumToExchangeVersionMappingHelper.EventType, eventType, _this.Service.RequestedServerVersion);
        });
    };
    /**
