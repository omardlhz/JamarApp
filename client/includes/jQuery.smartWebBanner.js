...
;(function($){
	$.fn.smartWebBanner = function(options){
		...
		function createBanner(){
			$('body').append('<div id="smartWebBanner"><a href="#" id="swb-close">X</a><a href="#" id="swb-icon"></a><div id="swb-info"><strong>'+opts.title+'</strong><span>'+opts.author+'</span></div><a href="#" id="swb-save">INSTALAR</a></div><div id="swb-instructions">Presiona <span class="icon"></span> y luego <strong>Añadir a Pantalla de Inicio</strong><div class="arrow"></div></div>');
			if(iPad)
