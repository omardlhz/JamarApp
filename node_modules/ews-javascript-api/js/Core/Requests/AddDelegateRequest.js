...
var AddDelegateRequest = (function (_super) {
    ...
    AddDelegateRequest.prototype.Validate = function () {
        ...
        if (this.MeetingRequestsDeliveryScope) {
            EwsUtilities_1.EwsUtilities.ValidateEnumVersionValue(EnumToExchangeVersionMappingHelper_1.EnumToExchangeVersionMappingHelper.MeetingRequestsDeliveryScope, this.MeetingRequestsDeliveryScope, this.Service.RequestedServerVersion); //info: EnumToExchangeVersionMappingHelper used to overcome Reflection limitation.
        }
    };
    /**
