...
WSDL.prototype.findChildSchemaObject = function(parameterTypeObj, childName, isInsideSchemaMS) {
  ...
  if (object.children) {
    for (i = 0, child; child = object.children[i]; i++) {
      found = this.findChildSchemaObject(child, childName, isInsideSchemaMS);
      if (found) {
        break;
      }
