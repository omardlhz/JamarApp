...
var UserConfiguration = (function () {
    function UserConfiguration(service, requestedProperties) {
        ...
        if (service.RequestedServerVersion < UserConfiguration.ObjectVersion) {
            throw new ServiceVersionException_1.ServiceVersionException(ExtensionMethods_1.StringHelper.Format(Strings_1.Strings.ObjectTypeIncompatibleWithRequestVersion, "UserConfiguration", UserConfiguration.ObjectVersion));
        }
    ...
    UserConfiguration.prototype.Delete = function () {
        if (this.isNew) {
            PromiseFactory_1.PromiseFactory.reject(new InvalidOperationException_1.InvalidOperationException(Strings_1.Strings.DeleteInvalidForUnsavedUserConfiguration));
        }
        else {
    ...
    UserConfiguration.prototype.Update = function () {
        var _this = this;
        if (this.isNew) {
            PromiseFactory_1.PromiseFactory.reject(new InvalidOperationException_1.InvalidOperationException(Strings_1.Strings.CannotUpdateNewUserConfiguration));
        }
        if (this.IsPropertyUpdated(UserConfigurationProperties_1.UserConfigurationProperties.BinaryData) ||
            ...
            this.ResetIsDirty();
            return PromiseFactory_1.PromiseFactory.resolve(void 0);
        }
    };
    /**
