...
var MeetingRequest = (function (_super) {
    ...
    function MeetingRequest(parentAttachmentOrService) {
        _super.call(this, parentAttachmentOrService);
    }
     ...
     * @return  {IPromise<CalendarActionResults>}       A CalendarActionResults object containing the various items that were created or modified as a results of this operation    :Promise.
     */
    MeetingRequest.prototype.AcceptTentatively = function (sendResponse) { throw new Error("MeetingRequest.ts - AcceptTentatively : Not implemented."); };
